  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
      <header className="pt-16 pb-8 text-center px-6">
        ...
        <p className="mt-4 text-sm opacity-40">by Geloy Concepcion</p>
        ...
        <nav className="mt-10 flex justify-center gap-8 text-[11px] uppercase tracking-[0.3em]">
          ...
          <a href="/letters-to-geloy" className="opacity-50 hover:opacity-100 transition">
            Letters to Geloy
          </a>
          <a href="/submit" className="opacity-50 hover:opacity-100 transition">
            Submit
          </a>
        </nav>
      </header>
